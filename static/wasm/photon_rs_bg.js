// File adapted from @silvia-odwyer/photon/photon_rs_bg.js
// * Replace `import * as wasm from './photon_rs_bg.wasm'` with deno-friendly initialization logic

/* BEGIN deno-friendly initialization logic */
let wasm;

export function initialize(_wasm) {
    wasm = _wasm;
}
...
/* END deno-friendly initialization logic */
